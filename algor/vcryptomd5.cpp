...
#include "vcryptomd5.h"

namespace  fcpp{

vcryptomd5::vcryptomd5()
{
    _buf[0] = 0x67452301;
    _buf[1] = 0xefcdab89;
    _buf[2] = 0x98badcfe;
...
vbytes vcryptomd5::compute()
{
    ...
    *p++ = 0x80;
    ...
    _in[14] = _bytes.length32[0] << 3;
    _in[15] = _bytes.length32[1] << 3 | _bytes.length32[0] >> 29;
    computeStep(_in);

    byteSwap(_buf, 4);
    vbytes digest(16);
    memcpy(digest.data(), _buf, 16);
...
void vcryptomd5::computeStep(vuint32 const in[16])
{
    vuint32 a, b, c, d;
